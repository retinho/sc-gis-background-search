...
| Auswahl aufheben | Freie Kartenstelle anklicken oder `Esc` drücken | Die Markierung und das Such-Popup werden entfernt; fremde Kartengrafiken bleiben erhalten. |
